...
`ifndef CPU_INT_ECLIC2_TEST_SV
`define CPU_INT_ECLIC2_TEST_SV

class cpu_int_eclic2_test extends cpu_int_eclic_base_test;
    `uvm_component_utils(cpu_int_eclic2_test)
    extern function new(string name = "cpu_int_eclic2_test", uvm_component parent = null);
    extern virtual task main_phase(uvm_phase phase);
endclass

function cpu_int_eclic2_test::new(string name = "cpu_int_eclic2_test", uvm_component parent = null);
    super.new(name,parent);

endfunction:new

task cpu_int_eclic2_test::main_phase(uvm_phase phase);
    bit[7:0] clk_flg = 0;
    int start_time;
    int end_time;
    int freq = 0;
