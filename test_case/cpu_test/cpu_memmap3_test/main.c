...
int main(void)
{
    ...
    cpu_info("Case3 memory test starting (UCIE/DDR/HS/new regions)\n");

    // test_memory_array(jtag_ap_ddr_sub_addr, sizeof(jtag_ap_ddr_sub_addr)/sizeof(MemTypeDef_t), "jtag_ap_ddr_sub_addr");
    test_memory_array(jtag_ap_media_sub_addr, sizeof(jtag_ap_media_sub_addr)/sizeof(MemTypeDef_t), "jtag_ap_media_sub_addr");
    test_memory_array(jtag_ap_aon_sub_addr, sizeof(jtag_ap_aon_sub_addr)/sizeof(MemTypeDef_t), "jtag_ap_aon_sub_addr");
