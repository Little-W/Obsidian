`ifndef I3C1_MASTER_MODE_I2C_FM_RATE_TEST__SV
`define I3C1_MASTER_MODE_I2C_FM_RATE_TEST__SV
class i3c1_master_mode_i2c_fm_rate_test extends i3c_base_test;
   `uvm_component_utils(i3c1_master_mode_i2c_fm_rate_test)

   extern function new(string name = "i3c1_master_mode_i2c_fm_rate_test", uvm_component parent = null);
   extern virtual function void build_phase(uvm_phase phase);
   extern virtual task main_phase(uvm_phase phase);

endclass: i3c1_master_mode_i2c_fm_rate_test
//-------------------------------------------------------------------------
function i3c1_master_mode_i2c_fm_rate_test::new(string name = "i3c1_master_mode_i2c_fm_rate_test", uvm_component parent = null);
    super.new(name, parent);
       
endfunction: new
//-------------------------------------------------------------------------
function void i3c1_master_mode_i2c_fm_rate_test::build_phase(uvm_phase phase);
...
//-------------------------------------------------------------------------
task i3c1_master_mode_i2c_fm_rate_test::main_phase(uvm_phase phase);
    bit[31:0] wdata ;
    bit[31:0] rdata ;
    bit[7:0] tx_data_q[$];
   ...
   noc_reg_read(`I3C1_BASE+`INTR_STATUS, rdata);
    ...
    i3c_set_transfer_cmd(1,7,0,0,0,0,2,1);//speed:i2c_fm:7
...
endtask: main_phase
//-------------------------------------------------------------------------
`endif //I3C1_MASTER_MODE_I2C_FM_RATE_TEST__SV
