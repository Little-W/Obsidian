`ifndef I3C1_TRANS_TXFIFO_TO_MEM_WITHDMA_TEST__SV
`define I3C1_TRANS_TXFIFO_TO_MEM_WITHDMA_TEST__SV
class i3c1_trans_txfifo_to_mem_withdma_test extends i3c_base_test;
   `uvm_component_utils(i3c1_trans_txfifo_to_mem_withdma_test)

   extern function new(string name = "i3c1_trans_txfifo_to_mem_withdma_test", uvm_component parent = null);
   extern virtual function void build_phase(uvm_phase phase);
   extern virtual task main_phase(uvm_phase phase);

endclass: i3c1_trans_txfifo_to_mem_withdma_test
//-------------------------------------------------------------------------
function i3c1_trans_txfifo_to_mem_withdma_test::new(string name = "i3c1_trans_txfifo_to_mem_withdma_test", uvm_component parent = null);
    super.new(name, parent);
       
endfunction: new
//-------------------------------------------------------------------------
function void i3c1_trans_txfifo_to_mem_withdma_test::build_phase(uvm_phase phase);
...
//-------------------------------------------------------------------------
task i3c1_trans_txfifo_to_mem_withdma_test::main_phase(uvm_phase phase);
   ...
   noc_reg_read(`I3C1_BASE+`INTR_STATUS, rdata);
    ...
    i3c_set_transfer_cmd(1,0,0,0,0,0,2,1);//speed:sdr0:0
    i3c_check_tx_response(1, 4'h2, tx_data_q.size());
    //@0:slave_num  
...
endtask: main_phase
//-------------------------------------------------------------------------
`endif //I3C1_TRANS_TXFIFO_TO_MEM_WITHDMA_TEST__SV
