`ifndef I2C1_SLAVE_I2C_FM_PLUS_TRANSMIT_TRANS_TEST__SV
`define I2C1_SLAVE_I2C_FM_PLUS_TRANSMIT_TRANS_TEST__SV

class i2c1_slave_i2c_fm_plus_transmit_trans_test extends i3c_base_test;
   `uvm_component_utils(i2c1_slave_i2c_fm_plus_transmit_trans_test)

   i3c_vip_i2c_mst_read_sequence mst_seq;

   extern function new(string name = "i2c1_slave_i2c_fm_plus_transmit_trans_test", uvm_component parent = null);
   extern virtual function void build_phase(uvm_phase phase);
   extern virtual task main_phase(uvm_phase phase);

endclass: i2c1_slave_i2c_fm_plus_transmit_trans_test
//-------------------------------------------------------------------------
function i2c1_slave_i2c_fm_plus_transmit_trans_test::new(string name = "i2c1_slave_i2c_fm_plus_transmit_trans_test", uvm_component parent = null);
    super.new(name, parent);
       
endfunction: new
//-------------------------------------------------------------------------
function void i2c1_slave_i2c_fm_plus_transmit_trans_test::build_phase(uvm_phase phase);
...
//-------------------------------------------------------------------------
task i2c1_slave_i2c_fm_plus_transmit_trans_test::main_phase(uvm_phase phase);
    bit[31:0] wdata ;
    bit[31:0] rdata ;
    bit[7:0] tx_data_q[$];
    ...
    fork
        begin         
           ...
           //1.set slave
            ...
            i3c_set_transfer_cmd(1, 1, 1, 8'h87, 0, 0,1,1);
...
endtask: main_phase
//-------------------------------------------------------------------------
`endif //I2C1_SLAVE_I2C_FM_PLUS_TRANSMIT_TRANS_TEST__SV
