`ifndef I2C0_SLAVE_I2C_FM_TRANSMIT_TRANS_TEST__SV
`define I2C0_SLAVE_I2C_FM_TRANSMIT_TRANS_TEST__SV

class i2c0_slave_i2c_fm_transmit_trans_test extends i3c_base_test;
   `uvm_component_utils(i2c0_slave_i2c_fm_transmit_trans_test)

   i3c_vip_i2c_mst_read_sequence mst_seq;

   extern function new(string name = "i2c0_slave_i2c_fm_transmit_trans_test", uvm_component parent = null);
   extern virtual function void build_phase(uvm_phase phase);
   extern virtual task main_phase(uvm_phase phase);

endclass: i2c0_slave_i2c_fm_transmit_trans_test
//-------------------------------------------------------------------------
function i2c0_slave_i2c_fm_transmit_trans_test::new(string name = "i2c0_slave_i2c_fm_transmit_trans_test", uvm_component parent = null);
    super.new(name, parent);
       
endfunction: new
//-------------------------------------------------------------------------
function void i2c0_slave_i2c_fm_transmit_trans_test::build_phase(uvm_phase phase);
...
//-------------------------------------------------------------------------
task i2c0_slave_i2c_fm_transmit_trans_test::main_phase(uvm_phase phase);
    bit[31:0] wdata ;
    bit[31:0] rdata ;
    bit[7:0] tx_data_q[$];
...
endtask: main_phase
//-------------------------------------------------------------------------
`endif //I2C0_SLAVE_I2C_FM_TRANSMIT_TRANS_TEST__SV
