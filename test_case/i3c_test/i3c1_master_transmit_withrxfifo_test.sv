`ifndef I3C1_MASTER_TRANSMIT_WITHRXFIFO_TEST__SV
`define I3C1_MASTER_TRANSMIT_WITHRXFIFO_TEST__SV
class i3c1_master_transmit_withrxfifo_test extends i3c_base_test;
   `uvm_component_utils(i3c1_master_transmit_withrxfifo_test)
   i3c_vip_slv_write_sequence i3c_vip_slv_write_seq;
   
   extern function new(string name = "i3c1_master_transmit_withrxfifo_test", uvm_component parent = null);
   extern virtual function void build_phase(uvm_phase phase);
   extern virtual task main_phase(uvm_phase phase);

endclass: i3c1_master_transmit_withrxfifo_test
//-------------------------------------------------------------------------
function i3c1_master_transmit_withrxfifo_test::new(string name = "i3c1_master_transmit_withrxfifo_test", uvm_component parent = null);
    super.new(name, parent);
       
endfunction: new
//-------------------------------------------------------------------------
function void i3c1_master_transmit_withrxfifo_test::build_phase(uvm_phase phase);
...
//-------------------------------------------------------------------------
task i3c1_master_transmit_withrxfifo_test::main_phase(uvm_phase phase);
    bit[31:0] wdata ;
    bit[31:0] rdata ;
    bit[7:0]  rx_data_q[$];
    ...
    fork 
      begin 
        ...
        //5.0 set transfer arg [@--0:i3c_num 1:data_lenth --@]
       ...
       //5.1 =================================================
        ...
        i3c_set_transfer_cmd(1,0,0,0,0,1,2,1);//cmd invalid

        //7.read data from rxffifo
        // @@@### 0: i3c_num, 1:data_lenth, 2:tx_thld ###
        i3c_read_data_from_rxfifo(1, 1, 1,rx_data_q);  
...
endtask: main_phase
//-------------------------------------------------------------------------
`endif //I3C1_MASTER_TRANSMIT_WITHRXFIFO_TEST__SV
