`ifndef I3C0_MASTER_DIRECTED_CCC_TRANS_TEST__SV
`define I3C0_MASTER_DIRECTED_CCC_TRANS_TEST__SV
class i3c0_master_directed_ccc_trans_test extends i3c_base_test;
   `uvm_component_utils(i3c0_master_directed_ccc_trans_test)

   extern function new(string name = "i3c0_master_directed_ccc_trans_test", uvm_component parent = null);
   extern virtual function void build_phase(uvm_phase phase);
   extern virtual task main_phase(uvm_phase phase);

endclass: i3c0_master_directed_ccc_trans_test
//-------------------------------------------------------------------------
function i3c0_master_directed_ccc_trans_test::new(string name = "i3c0_master_directed_ccc_trans_test", uvm_component parent = null);
    super.new(name, parent);
       
endfunction: new
//-------------------------------------------------------------------------
function void i3c0_master_directed_ccc_trans_test::build_phase(uvm_phase phase);
...
//-------------------------------------------------------------------------
task i3c0_master_directed_ccc_trans_test::main_phase(uvm_phase phase);
    bit[31:0] wdata ;
    bit[31:0] rdata ;
    bit[7:0] tx_data_q[$];
   ...
   noc_reg_read(`I3C0_BASE+`INTR_STATUS, rdata);
    ...
    i3c_set_transfer_cmd(0,0,1,'h82,0,0,2,1);//speed:sdr0:
...
endtask: main_phase
//-------------------------------------------------------------------------
`endif //I3C0_MASTER_DIRECTED_CCC_TRANS_TEST__SV
