`ifndef I3C0_MASTER_SETAASA_TEST__SV
`define I3C0_MASTER_SETAASA_TEST__SV
class i3c0_master_setaasa_test extends i3c_base_test;
   `uvm_component_utils(i3c0_master_setaasa_test)

   i3c_default_slv_sequence i3c_vip_slv_seq ;

   extern function new(string name = "i3c0_master_setaasa_test", uvm_component parent = null);
   extern virtual function void build_phase(uvm_phase phase);
   extern virtual task main_phase(uvm_phase phase);

endclass: i3c0_master_setaasa_test
//-------------------------------------------------------------------------
function i3c0_master_setaasa_test::new(string name = "i3c0_master_setaasa_test", uvm_component parent = null);
    super.new(name, parent);
       
endfunction: new
//-------------------------------------------------------------------------
function void i3c0_master_setaasa_test::build_phase(uvm_phase phase);
...
//-------------------------------------------------------------------------
task i3c0_master_setaasa_test::main_phase(uvm_phase phase);
    bit[31:0] wdata ;
    bit[31:0] rdata ;
      bit[7:0] tx_data_q[$];
...
endtask: main_phase
//-------------------------------------------------------------------------
`endif //I3C0_MASTER_SETAASA_TEST__SV
