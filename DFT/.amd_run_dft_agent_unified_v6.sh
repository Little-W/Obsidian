...
dataset="$root/data/training/dft_agent_unified_v6_candidate_20260830.jsonl"
model="$root/models/Qwen3.5-4B"
output="$root/artifacts/training/amd/dft_agent_unified_v6_qwen35_4b_20260830"
...
test "$(sha256sum "$dataset" | awk '{print $1}')" = "a70b5dccd6d2bb573963478181bbbc6e3995286fc0a380a99348eed83d5c9cc2"
test -d "$model"
if [ -e "$output" ]; then
