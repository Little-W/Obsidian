...
dataset="$root/data/training/dft_agent_unified_v2_20260830.jsonl"
model="$root/models/Qwen3.5-4B"
output="$root/artifacts/training/amd/dft_agent_unified_v2_qwen35_4b_20260830"
...
test "$(sha256sum "$dataset" | awk '{print $1}')" = "d42796275ed76200248aade8e51270ca3fc3ccae248965858857c73323baa154"
test "$(sha256sum "$root/src/dft_agent_flow/train_lora.py" | awk '{print $1}')" = "e0b370ce88103f1248998058fe3899bbb3c44335353fa4e079a94f0c85d757a6"
test -d "$model"
if [ -e "$output" ]; then
