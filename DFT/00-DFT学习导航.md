...
> 这是一套从数字电路可测性、扫描链、DFT Compiler/DC 命令，到实验流程的整理版笔记。
> 原始 PDF 保留在本目录中；Markdown 正文经过中文化、去噪和主题重排。
...
| 3 | [[dc指令/Synopsys-DFTC-Lab]] | DFT Compiler 工作坊的完整流程映射 |
