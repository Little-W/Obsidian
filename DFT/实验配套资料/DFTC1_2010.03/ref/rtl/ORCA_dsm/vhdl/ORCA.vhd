...
--   SIGNAL buf_scan_en    : std_logic;
  ...
  SIGNAL pci_rst_n, sdram_rst_n, sys_rst_n, sys_2x_rst_n : std_logic;
...
--     );
  ...
  pll_reset_iopad: pc3d01 PORT MAP
    (     
      PAD => pll_reset,
      CIN => s_pll_reset
    );
...
--   I_CLK_SOURCE_SCAN_EN : bufbd7 PORT MAP (
--     A => s_scan_en,
--     Y => buf_scan_en
--   );
