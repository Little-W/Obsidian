...
foreach design $designs {
	...
	# Define the main clocks (disregard any errors!!)
	create_clock -period 15.0 [get_ports pclk]
	create_clock -period 8.0 [get_ports sys_clk]
	create_clock -period 8.0 [get_ports clk]
	create_clock -period 7.5 [get_ports sdram_clk]
	create_clock -period 7.5 [get_ports fifo_clk*]
    ...
    # Create then save the ILM, which includes the test model

    create_ilm
    write -format ddc -hierarchy -output dc_ilms/${design}.ddc
