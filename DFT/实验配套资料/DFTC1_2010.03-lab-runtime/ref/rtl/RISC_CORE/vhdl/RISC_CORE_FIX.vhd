...
architecture STRUCT of RISC_CORE is
    ...
    component ALU
         port (
	      INTERNAL_RESET, Clk	: in std_logic;	
              Oprnd_A, 
    ...
    component CONTROL 
         port (
              Clk, INTERNAL_RESET	: in std_logic; 
    ...
    component DIV_CLK
         port (
              TEST_MODE,INTERNAL_RESET,Clk	: in std_logic;              
    ...
    component RST
         port (
              TEST_MODE,RESET,Clk		: in std_logic;              
