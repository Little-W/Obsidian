package npu_rtl_pkg;
  ...
  function automatic logic [11:0] npu_cmd_event_ref(
  ...
  function automatic logic [11:0] npu_cmd_wait0(
    ...
    return npu_cmd_event_ref(command[111:104]);
  endfunction

  function automatic logic [11:0] npu_cmd_wait1(
    input logic [127:0] command
  );
    return npu_cmd_event_ref(command[103:96]);
  endfunction

  function automatic logic [11:0] npu_cmd_signal(
    input logic [127:0] command
  );
    return npu_cmd_event_ref(command[95:88]);
  endfunction
