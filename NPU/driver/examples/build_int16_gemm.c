...
int main(void)
{
    ...
    common.src1_dtype = NPU_DRV_DTYPE_INT16;
    ...
    matrix.lda_bytes = 16u;
    matrix.ldc_bytes = 16u;
    matrix.a_pack_format = NPU_DRV_PACK_LINEAR_INT16;
    matrix.b_pack_format = NPU_DRV_PACK_TILED_INT16;
    matrix.c_pack_format = NPU_DRV_PACK_LINEAR_INT16;
