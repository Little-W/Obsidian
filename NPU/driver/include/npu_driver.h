...
#define NPU_DRV_PHYS_ADDR_BITS 40u
#define NPU_DRV_PHYS_ADDR_MASK UINT64_C(0x000000ffffffffff)
#define NPU_DRV_L1_ADDR_MASK UINT64_C(0x00000000000fffff)
...
#define NPU_DRV_REG_M_AXI_ADDR_BASE UINT32_C(0x0080)
#define NPU_DRV_REG_M_AXI_ADDR_LIMIT UINT32_C(0x0088)
