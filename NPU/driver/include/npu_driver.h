...
#define NPU_DRV_CMD_HEADER_VERSION 2u
...
typedef enum {
    NPU_DRV_COMPACT_NOP = 0,
    NPU_DRV_COMPACT_EVENT_SIGNAL = 1,
    NPU_DRV_COMPACT_EVENT_REARM = 2,
    NPU_DRV_COMPACT_EVENT_JOIN = 3,
    NPU_DRV_COMPACT_GLOBAL_FENCE = 4,
    NPU_DRV_COMPACT_DMA_COPY_1D = 5,
    NPU_DRV_COMPACT_DMA_COPY_ND = 6,
    NPU_DRV_COMPACT_DMA_FILL = 7,
    NPU_DRV_COMPACT_DMA_TRANSPOSE_2D = 8,
    NPU_DRV_COMPACT_DMA_PACK = 9,
    NPU_DRV_COMPACT_DMA_SPLIT = 10,
    NPU_DRV_COMPACT_MATRIX_GEMM = 11,
    NPU_DRV_COMPACT_MATRIX_BMM = 12,
    NPU_DRV_COMPACT_MATRIX_GEMM_ACCUM = 13,
    NPU_DRV_COMPACT_MATRIX_GEMM_ZERO = 14,
    NPU_DRV_COMPACT_VECTOR_ADD = 15,
    NPU_DRV_COMPACT_VECTOR_SUB = 16,
    NPU_DRV_COMPACT_VECTOR_MUL = 17,
    NPU_DRV_COMPACT_VECTOR_FMA = 18,
    NPU_DRV_COMPACT_VECTOR_MAX = 19,
    NPU_DRV_COMPACT_VECTOR_MIN = 20,
    NPU_DRV_COMPACT_VECTOR_CMP = 21,
    NPU_DRV_COMPACT_VECTOR_SELECT = 22,
    NPU_DRV_COMPACT_VECTOR_CLAMP = 23,
    NPU_DRV_COMPACT_VECTOR_RELU = 24,
    NPU_DRV_COMPACT_COMPLEX_ACT = 25,
    NPU_DRV_COMPACT_COMPLEX_SOFTMAX = 26,
    NPU_DRV_COMPACT_COMPLEX_NORM = 27,
    NPU_DRV_COMPACT_COMPLEX_ROPE = 28,
    NPU_DRV_COMPACT_COMPLEX_STAT = 29,
    NPU_DRV_COMPACT_COMPLEX_RECIP = 30,
    NPU_DRV_COMPACT_COMPLEX_ADD_RESCALE = 31
