 ...
 */
`ifndef GUARD_APB_RAL_BASE_TEST_SV
`define GUARD_APB_RAL_BASE_TEST_SV
...
class apb_ral_base_test extends uvm_test;
  ...
  apb_ral_env env;
  apb_ral_env_ba env_ba;

  /** Customized configuration */
  apb_shared_cfg cfg;

  /** Class Constructor */
  function new(string name = "apb_ral_base_test", uvm_component parent=null);
  ...
  virtual function void build_phase(uvm_phase phase);
    ...
    uvm_config_db#(apb_shared_cfg)::set(this, "env_ba", "cfg", this.cfg);

    /** Create the environment */
    env = apb_ral_env::type_id::create("env", this);
    env_ba = apb_ral_env_ba::type_id::create("env_ba", this);
    ...
    uvm_config_db#(uvm_object_wrapper)::set(this, "env_ba.apb_master_env.sequencer.main_phase", "default_sequence", apb_master_random_discrete_virtual_sequence::type_id::get());
    ...
    uvm_config_db#(int unsigned)::set(this, "env_ba.apb_master_env.sequencer.apb_master_random_discrete_virtual_sequence", "sequence_length", 50);
    ...
    uvm_config_db#(uvm_object_wrapper)::set(this, "env_ba.apb_slave_env.slave*.sequencer.run_phase", "default_sequence", svt_apb_slave_memory_sequence::type_id::get());
...
`endif // GUARD_APB_RAL_BASE_TEST_SV
