 ...
 *  - Create a default configuration and set it to the ahb_ral_env instance
 *    using the configuration DB
 *  - Create the ahb_ral_env instance (named env)
 ...
 */
`ifndef GUARD_AHB_RAL_BASE_TEST_SV
`define GUARD_AHB_RAL_BASE_TEST_SV
...
class ahb_ral_base_test extends uvm_test;
  ...
  /** Class Constructor */
  function new(string name = "ahb_ral_base_test", uvm_component parent=null);
  ...
  virtual function void build_phase(uvm_phase phase);
    ...
    env = ahb_ral_env::type_id::create("env", this);
...
`endif // GUARD_AHB_RAL_BASE_TEST_SV
