...
> 整理说明：由本地保存的知乎 HTML 清洗为 Markdown，保留原文问答内容，并按题号重新分节。
...
所属专栏 · 2022-05-22 09:31 更新芯片社区Thomas西安电子科技大学 信息与通信工程硕士84 篇内容 · 6803 赞同最热内容 ·IC公司965白名单(持续更新）发布于 2020-06-05 11:50数字IC设计数字电路数字集成电路用豆包，做轻松打工人，创意文案、代码生成，不加班别再熬夜写周报、做 PPT！豆包AI一键生成文案 / 纪要 / 表格，职场效率直接拉满？查看详情别再熬夜写周报、做 PPT！豆包AI一键生成文案 / 纪要 / 表格，职场效率直接拉满？ 查看详情豆包的广告理性发言，友善互动 9 条评论默认最新特约评论员请问学长，数字ic方向会不会向cs那样中年危机严重，是比较吃经验的吗2020-07-04知乎用户9Lzwft

相对好很多，能干到50

2022-12-09纠结的天秤同问2020-07-05Harry33. 补充一下为什么：关键信号意味着其权重大，放到最后意味着线长变短。每个信号的权重乘以其线长的加和，放到最后可以减少关键路径长度，从而提高速度2021-07-14无名小菜花请问这是考研的笔试还是找工作的笔试哇2020-10-13追风筝呐呐重温了一遍数电2020-09-05Sihao Chen

61是不是有问题啊Thold应该是小于吧？

2020-08-09Joshua Pang

欸 现在看这些感觉恍如隔世 当年天天刷这些为了找工作 最后鬼使神差的做了opc 跟前端的设计验证都拜拜了

2020-06-23Thomas作者2020-06-23关于作者Thomas公众号 : 数字ICer ，内推公众号：芯聘西安电子科技大学 信息与通信工程硕士回答12文章106关注者7,547大家都在搜换一换豆包疑误导老人断指泡盐水致残492 万热宝妈称带孩子去山姆是托举引争议374 万热国企干部离婚近亿资产来源不明353 万热高考加油的文案353 万宁夏事业编考生因围报被取消资格353 万热粉笔CEO张小龙辱骂人大学生337 万热官方通报女大学生被骗入戒网瘾学校331 万热如何让考试超常发挥的玄学330 万AI脸引发网友生理性厌恶329 万热王楚钦任国乒男队队长320 万热

推荐阅读

数字IC设计职位经典笔试面试100题(31~40)

温戈发表于数字芯片设...

数字IC设计基本概念之创建时钟

来自微信公众号 “数字芯片实验室”时序分析的一个重要部分是准确地指定时钟和相关属性，例如延迟 （latency）和不确定性（uncertainty）。 EDA工具可以分析以下类型的时钟信息： 时钟网络l…
...
关键词： 同步，异步 由第 3 章可知，当触发器输入端的数据和触发器的时钟不相关时，很容易导致电路时序不满足。本章主要解决模块间可导致时序 violation 的异步问题。 关于异步与同步的定…

数字IC与好好生活想来知乎工作？请发送邮件到 jobs@zhihu.com
